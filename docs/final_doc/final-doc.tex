...
\subsection{Kevin Talik - Team Lead}
	...
	I had felt prior to this project that I had to choose between my hobbies of performing comedy, or professional career.
	Furthermore, I have learned that even though I have worn a "Software Engineering" hat for most of my schooling, I would have to wear many hats that I previously thought did not fit (see \textit{The Night Watch } by James Mickens).
	After concluding this project, I have learned that it is not a choice between one or the other, but balancing both for the success of a project.
	...
	\subsection{Summary}
		...
		The Robot comedian had a working research components of each person of this group, however, the engineering of the actual robot failed many test cases.
		Since all of our systems were designed alone, without any concrete development processes or repository managment, our systems often \textit{worked} alone.
		...
		During Week 5 of Winter Term, I had discovered that we sent our client a requirements document that had read-write permissions, and my required work had changed outside of my understanding during the approval process.
		The scope of this project was intentionally large, which is valuable to research, but detrimental to software.

		The most important step during this was fixing this mistake early, so that my direction of research had not wandered too far from the marked path.
		The value of these design and requirements documents is to plan work so that software can be designed, tested, and iterated. 
		Software iterates significantly slower than physical designs, and virtual mistakes are easier to make.

		\subsection{Engineering Decisions}

		\subsection{Entertainment Decisions}

	The most important tool that I have put into my tool chest is the double edged, diamond forged, impeccibly sharp dagger of \textit{Failure} \cite{noSilverBullet}. 
	...
	The unforntuate, and most effective comedic device that we used was "Self-Depreciation", because the crowd could laugh at a robot who told bad jokes.

	Moreover, I think that Stand-Up comedy can be, but \textit{should not} be compared as "Robot Vs Human". 
	This can insenuate an equality in what a human can do and what a robot should do, and these are not at all comparable nouns.
	Robots are tools, they should be considered as a "means through an end." The developer of the robot must identify dangers and repercussions of a machine before it is created.
	A robot should never make this ethical distinction.
	Conversly, a human should be considered as an "end through means." A human can complete tasks, but it is not ethical to obviscate the results of a task.
	A human can make ethical decisions about what to say in front of a crowd of people, and a robot should \textit{never} make ethical decisions.
	...
	This is so that an observer does not insinuate that a robot should be doing comedy.
