...
\section{Crowdwork (Anish Asrani)}
...
Below is an image of our robot, Ginger, falling down before I could catch her.
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth,height=0.75\textheight,keepaspectratio]{ginger_dies}
  \caption{Ginger falling down and dying.}
	\label{fig:ginger_dies}
\end{figure}
