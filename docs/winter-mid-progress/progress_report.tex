...
%INSERT FIGURE 1
User-defined classes can be added to the visual environment of \texit{Choreographe} by editing the generated code of a visual block. The class needs to be appended (with additional library imports) at the top of the generated code.
