...
\section{Research Design Overview}
  	This section will cover the research questions for evaluating the effectiveness of a robot comedian. These questions will be the basis of the implementation of the comedian system. All three research questions will be presented including the goals of the expected research and the methods of investigation.

  	The comedian system that is implemented will test three critical areas of a comedic performance corresponding to our research. The first question is about adaptation of a performance, and how the robot and interpret an audience response. The second question studies ‚ÄúCrowd Work‚Äù during a show, and the choices a Comedian can make to engage the audience. Lastly, the third considers the implications of a perceivable character that the Robot can portray.
...
We believe that keeping the audience engaged and interacting with them (a.k.a crowd-work) throughout the performance improves their overall enjoyment of the show. We want to analyze the importance of this crowd-work relating to the central design of the project. 
Crowd-work makes the audience feel like they are a part of the show. This can be done in different ways - calling out and talking to the audience, listening to the audience and
making relevant comments, asking them questions to keep them engaged.
...
example, the robot could ask a simple question about the weather, or the audience member'Äôs hometown. The robot can
...
interaction are ÄùhumanÄù behaviors, the audience's response will be used to see if they enjoy a humanized robot or if
...
Participants will be shown a video of the robot‚Äôs stand-up routine, and then presented with a short survey.
